...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_message(kk.id, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @TN_Botz __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
...
async def op(_, m :Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton("🗯 Channel", url="https://t.me/tn_botz"),
            InlineKeyboardButton("💬 Support", url="https://t.me/+eBzYtdaY7Bc2ZDVl")
        ]]
    )
    add_user(m.from_user.id)
    await m.reply_photo("https://envs.sh/Qrd.jpg", caption="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powered By : @TN_Botz __**".format(m.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard)
